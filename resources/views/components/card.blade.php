  ...
  <div class="portfolio-item filter-app">
    <div class="portfolio-wrap">
      ...
      <div class="portfolio-info mt-3">
        ...
        <p class="text-black" style="line-height: 1em"> <span class="accenti">Prezzo:</span> {{$ad->price}}</p>
        <p class="text-black" style="line-height: 1.4em"><span class="accenti">Categoria:</span> {{$ad->category->name}}</p>
        <p class="text-black" style="line-height: 1em">{{$ad->description}}</p>
      </div>
    </div>
  </div>
</div>