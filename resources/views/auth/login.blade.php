                        ...
                        <div class="card-body">
                            <div class="m-sm-4">
                                <div class="text-center">
                                    <img src="https://images.pexels.com/photos/9496720/pexels-photo-9496720.jpeg"
                                ...
                                <form method="post" action={{ route('login') }}>
                                    ...
                                    <div class="row">
                                        <div class="text-center mt-3 col">
                                            <button type="submit"
                                                class="btn btn-presto btn-lg btn-primary">{{ __('messages.login') }}</button>
                                        </div>
                                        <div class="text-center mt-3 col">
                                            <a class="btn btn btn-presto btn-lg btn-primary"
