<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container row">
        <div class="container-fluid accenti col">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($categories as $category)
                                <li><a class="dropdown-item" href="{{ Route('ads.index') }}">{{ $category->name }}</a>
                                </li>
                            @endforeach
        ...
        <div class="d-flex justify-content-end col">
          ...
          <form action="{{route('logout')}}" method="POST">
            ...
            @else
            <a class="btn btn-success accenti" href='{{Route('login')}}'>Accedi</a>
            <a class="btn accenti" href='{{Route('register')}}'>Registrati</a>
          @endauth
